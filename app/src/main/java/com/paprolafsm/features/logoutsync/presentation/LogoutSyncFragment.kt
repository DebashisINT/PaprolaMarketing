package com.paprolafsm.features.logoutsync.presentation
...
import com.paprolafsm.CustomConstants
...
import com.paprolafsm.app.utils.Toaster
import com.paprolafsm.base.BaseResponse
import com.paprolafsm.base.presentation.BaseActivity
import com.paprolafsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.paprolafsm.features.billing.api.AddBillingRepoProvider
import com.paprolafsm.features.billing.model.AddBillingInputParamsModel
...
import com.paprolafsm.features.dashboard.presentation.ReasonDialog
...
import com.paprolafsm.features.document.model.AddEditDocumentInputParams
import com.paprolafsm.features.document.model.DocumentAttachmentModel
...
import com.paprolafsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.paprolafsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.paprolafsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.paprolafsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.paprolafsm.features.orderhistory.model.*
...
import com.paprolafsm.features.quotation.model.AddQuotInputModel
import com.paprolafsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.paprolafsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.paprolafsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.paprolafsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.paprolafsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.paprolafsm.features.timesheet.model.AddTimeSheetInputModel
import com.paprolafsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.paprolafsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.paprolafsm.features.viewAllOrder.model.AddOrderInputProductList
import com.paprolafsm.mappackage.SendBrod
import com.paprolafsm.widgets.AppCustomTextView
import com.paprolafsm.MonitorService
import com.paprolafsm.MySingleton
import com.paprolafsm.features.addshop.model.*
import com.paprolafsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.paprolafsm.features.addshop.presentation.ShopExtraContactReq
import com.paprolafsm.features.addshop.presentation.multiContactRequestData
import com.paprolafsm.features.login.api.LoginRepositoryProvider
import com.paprolafsm.features.login.model.GetConcurrentUserResponse
import com.paprolafsm.features.login.model.WhatsappApiData
import com.paprolafsm.features.performance.model.Gps_status_list
import com.paprolafsm.features.performance.model.UpdateGpsInputListParamsModel
import com.paprolafsm.features.returnsOrder.ReturnProductList
import com.paprolafsm.features.returnsOrder.ReturnRequest
import com.paprolafsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpaprolafsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpaprolafsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpaprolafsmlogsample/log.zip").path);
