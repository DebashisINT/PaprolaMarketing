package com.paprolafsmnew.features.logoutsync.presentation
...
import com.paprolafsmnew.CustomConstants
...
import com.paprolafsmnew.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.paprolafsmnew.features.billing.api.AddBillingRepoProvider
import com.paprolafsmnew.features.billing.model.AddBillingInputParamsModel
...
import com.paprolafsmnew.features.dashboard.presentation.ReasonDialog
...
import com.paprolafsmnew.features.document.model.AddEditDocumentInputParams
import com.paprolafsmnew.features.document.model.DocumentAttachmentModel
...
import com.paprolafsmnew.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.paprolafsmnew.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.paprolafsmnew.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.paprolafsmnew.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.paprolafsmnew.features.orderhistory.model.*
...
import com.paprolafsmnew.features.quotation.model.AddQuotInputModel
import com.paprolafsmnew.features.shopdetail.presentation.api.EditShopRepoProvider
import com.paprolafsmnew.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.paprolafsmnew.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.paprolafsmnew.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.paprolafsmnew.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.paprolafsmnew.features.timesheet.model.AddTimeSheetInputModel
import com.paprolafsmnew.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.paprolafsmnew.features.viewAllOrder.model.AddOrderInputParamsModel
import com.paprolafsmnew.features.viewAllOrder.model.AddOrderInputProductList
import com.paprolafsmnew.mappackage.SendBrod
import com.paprolafsmnew.widgets.AppCustomTextView
import com.paprolafsmnew.MonitorService
import com.paprolafsmnew.MySingleton
import com.paprolafsmnew.features.addshop.model.*
import com.paprolafsmnew.features.addshop.model.assigntopplist.AddShopUploadImg
import com.paprolafsmnew.features.addshop.presentation.ShopExtraContactReq
import com.paprolafsmnew.features.addshop.presentation.multiContactRequestData
import com.paprolafsmnew.features.login.api.LoginRepositoryProvider
import com.paprolafsmnew.features.login.model.GetConcurrentUserResponse
import com.paprolafsmnew.features.login.model.WhatsappApiData
import com.paprolafsmnew.features.performance.model.Gps_status_list
import com.paprolafsmnew.features.performance.model.UpdateGpsInputListParamsModel
import com.paprolafsmnew.features.returnsOrder.ReturnProductList
import com.paprolafsmnew.features.returnsOrder.ReturnRequest
import com.paprolafsmnew.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpaprolafsmnewlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpaprolafsmnewlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpaprolafsmnewlogsample/log.zip").path);
